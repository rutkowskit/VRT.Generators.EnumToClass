...
/// <summary>
/// One named enum member with documentation and attribute-property assignments.
/// </summary>
internal sealed record EnumFieldData
{
    ...
    private static List<AttributePropertyAssignment> BuildAttributeAssignments(
        IFieldSymbol fieldSymbol,
        IReadOnlyList<AttributePropertyProjection> projections,
        List<PendingDiagnostic> diagnostics)
    {
        ...
        {
            list.Add(AttributeProjectionEmitter.BuildAssignment(fieldAttributes, projection, diagnostics));
        }
